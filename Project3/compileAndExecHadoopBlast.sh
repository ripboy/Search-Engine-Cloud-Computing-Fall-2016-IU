...
cd /root/MoocHomeworks/Project3/resources/
# wget http://salsahpc.indiana.edu/tutorials/apps/BlastProgramAndDB.tar.gz
cd /root/MoocHomeworks/Project3/
# run Hadoop Blast
...
hadoop jar /root/MoocHomeworks/Project3/build/blast-hadoop.jar BlastProgramAndDB.tar.gz bin/blastx /tmp/hadoop-test/ db nr HDFS_blast_input HDFS_blast_output '-query #_INPUTFILE_# -outfmt 6 -seg no -out #_OUTPUTFILE_#'
